    ...
    <div class="header_top bg_black text-white clearfix">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <span class="offer_text">Free Shipping on Domestic Orders over $150</span>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <div class="brand_logo">
                        <a class="brand_link" href="#!">
                            <img src="assets/images/logo/logo.svg" srcset="assets/images/logo/logo_03_2x.png 2x" alt="logo_not_found">
                        </a>
