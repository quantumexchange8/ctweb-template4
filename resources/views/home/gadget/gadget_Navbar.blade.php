<header class="header_section gadget_header sticky_header clearfix">
    <div class="header_content_wrap d-flex align-items-center clearfix">
                ...
                <div class="col-lg-3">
                    <div class="brand_logo">
                        <a class="brand_link" href="/home">
                            <img src="assets/images/logo/logo.svg" srcset="assets/images/logo/logo_30_2x.png 2x" alt="logo_not_found">
                        </a>
        ...
        <a href="#!" class="order_btn bg_gadget_red text-uppercase">Make Order</a>
    </div>
