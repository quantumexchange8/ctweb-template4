<header class="header_section medical_header sticky_header clearfix">
    <div class="header_top bg_medical_blue text-white clearfix">
        <div class="container">
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-8">
                    <div class="header_contact_info clearfix">
                        <ul class="ul_li clearfix">
                            <li><i class="fas fa-phone-alt"></i> +123 (456) 7879</li>
                            <li><i class="fas fa-envelope"></i> Support@gmail.com</li>
                            <li><i class="fas fa-map-marker-alt"></i> 205 Main Street, USA</li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="header_middle clearfix">
        <div class="container">
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-3">
                    <div class="brand_logo">
                        <a class="brand_link" href="/home">
                            <img src="assets/images/logo/logo.svg" srcset="assets/images/logo/logo_11_2x.png 2x" alt="logo_not_found">
                        </a>
                ...
                <div class="col-lg-6">
                    <form action="#">
                        <div class="medical_search_bar clearfix">
                            <div class="form_item">
                                <input type="search" name="search" placeholder="search here...">
                            </div>
                            <div class="option_select mb-0">
                                <select>
                                    <option data-display="Search Category">Select A Option</option>
                ...
                <div class="col-lg-3">
                    <ul class="header_register_btns ul_li_right mb-1 clearfix">
                        <li><a href="/register_Login">Login</a></li>
                        <li><span class="or_text">or</span></li>
                        <li><a href="/register_signUp">Resister</a></li>
                    </ul>
                    <ul class="header_cartbtns_group ul_li_right clearfix">
                        <li><button type="button"><i class="far fa-heart"></i> Wishlist</button></li>
                        <li><button type="button" class="cart_btn"><i class="far fa-shopping-cart"></i> Cart 0</button></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="header_bottom clearfix">
        <div class="container">
            <div class="header_content_wrap bg_medical_blue clearfix">
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-9">
