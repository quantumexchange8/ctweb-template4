                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="footer_widget footer_about">
                        <div class="brand_logo mb_30">
                            <a href="/home">
                                <img src="assets/images/logo/logo.svg" srcset="assets/images/logo/logo_24_2x.png 2x" alt="logo_not_found">
                            </a>
                        </div>
                        ...
                        <div class="footer_widget footer_contact_info clearfix">
                            <ul class="ul_li_block">
                                ...
                                <li><span>Email:</span> currenttech@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <p class="copyright_text mb-0">
                        @2020 Designed By <a href="#!" class="author_link text-white">Current Tech</a>.
                    </p>
                </div>
