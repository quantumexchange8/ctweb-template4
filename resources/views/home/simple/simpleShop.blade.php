...
<main>
    ...
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="col-lg-6">
                <section class="slider_section simple_shop_slider clearfix">
                    <div class="main_slider clearfix">
                        <div class="item d-flex align-items-center" data-background="assets/images/slider/simple_shop/bg_01.jpg">
                            <div class="container">
                                <div class="row">
                                    <div class="slider_content">
                                        <h3 data-animation="fadeInUp" data-delay=".2s">Puffer jacket Up to 70% </h3>
                                        <p data-animation="fadeInUp" data-delay=".4s">Where to go and what to</p>
                                        <div class="abtn_wrap clearfix" data-animation="fadeInUp" data-delay=".6s">
                                            <a class="custom_btn bg_shop_red" href="#!">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="item d-flex align-items-center" data-background="assets/images/slider/simple_shop/bg_02.jpg">
                            <div class="container">
                                <div class="row">
                                    <div class="slider_content">
                                        <h3 data-animation="fadeInUp" data-delay=".2s">Puffer jacket Up to 70% </h3>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="simple_shop_banner" data-background="assets/images/banner/simple_shop/img_01.jpg">
                    <div class="item_content">
                        <h3 class="item_title text-white">Women</h3>
                        <ul class="ul_li_block mb_50 clearfix">
                            <li><a href="#!">Shirts</a></li>
                            <li><a href="#!">Fashion Hoodies </a></li>
                        ...
                        <a class="custom_btn btn_sm bg_white" href="#!">BROWSE ALL</a>
                    </div>
                </div>
            </div>

            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="simple_shop_banner" data-background="assets/images/banner/simple_shop/img_02.jpg">
                    <div class="item_content">
                        <h3 class="item_title text-white">Men</h3>
                        <ul class="ul_li_block mb_50 clearfix">
                            <li><a href="#!">Shirts</a></li>
                            <li><a href="#!">Fashion Hoodies </a></li>
                            <li><a href="#!">Jackets & Coats</a></li>
    ...
    ================================================== -->
    <section class="banner_section sec_ptb_100 clearfix">
        <div class="container maxw_1480">
            <div class="row">
                <div class="col-lg-6">
                    <div class="ss_new_srrivals">
                        <img src="assets/images/banner/simple_shop/img_03.jpg" alt="image_not_found">
                        <div class="item_content text-white text-center" data-bg-color="#000000">
                            <h3 class="text-white">New Arrivals</h3>
                            <p class="text-uppercase mb-0">SALE 30% ALL ITEMS</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="ss_new_srrivals">
                        <img src="assets/images/banner/simple_shop/img_04.jpg" alt="image_not_found">
                        <div class="item_content text-white text-center" data-bg-color="#000000">
                            <h3 class="text-white">New Arrivals</h3>
                            <p class="text-uppercase mb-0">SALE 30% ALL ITEMS</p>
                        </div>
    ...
    <section class="feature_section sec_ptb_100 clearfix" data-bg-color="#f7f7f7">
        <div class="container maxw_1480">
            ...
            <div class="ss_section_title text-center mb_30">
                <h2 class="title_text">Featured Product</h2>
                <p class="mb-0">Enjoy free U.S. shipping</p>
            </div>

            <div class="ss_featured_carousel arrow_ycenter position-relative">
                <div class="slideshow4_slider" data-slick='{"dots": false}'>
                    <div class="item">
                        <div class="ss_feature_item">
                            <div class="item_image">
                                <img src="assets/images/shop/simple_shop/img_01.png" alt="image_not_found">
                            </div>
                            <h3 class="item_title mb-0">Amazon Essentials</h3>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="ss_feature_item">
                            <div class="item_image">
                                <img src="assets/images/shop/simple_shop/img_02.png" alt="image_not_found">
                            </div>
                            <h3 class="item_title mb-0">Amazon Essentials</h3>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="ss_feature_item">
                            <div class="item_image">
                                <img src="assets/images/shop/simple_shop/img_03.png" alt="image_not_found">
                            </div>
                            <h3 class="item_title mb-0">Amazon Essentials</h3>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="ss_feature_item">
                            <div class="item_image">
                                <img src="assets/images/shop/simple_shop/img_04.png" alt="image_not_found">
                            </div>
                            <h3 class="item_title mb-0">Amazon Essentials</h3>
                        </div>
                    </div>
                ...
                <div class="carousel_nav">
                    <button type="button" class="ss4_left_arrow"><i class="fal fa-arrow-left"></i></button>
                    <button type="button" class="ss4_right_arrow"><i class="fal fa-arrow-right"></i></button>
                </div>
            </div>
    ...
    <!-- ss_big_feature - start
    ================================================== -->
    <section class="ss_big_feature parallaxie sec_ptb_100 text-center d-flex align-items-center clearfix" data-background="assets/images/feature/simple_shop/bg_01.jpg">
        <div class="container text-uppercase text-white">
            <a class="item_video" href="#!">
                <span><i class="fas fa-play"></i></span>
            </a>
            <h3 class="text-white">Promotion 2020 Fashion</h3>
            <p class="mb-0">Amazon Essentials</p>
        </div>
    </section>
    <!-- ss_big_feature - end
    ================================================== -->
    ...
    <section class="product_section sec_ptb_100 pb-0 clearfix">
        <div class="container maxw_1480">
            ...
            <div class="ss_section_title text-center">
                <h2 class="title_text">Recent Arrivals</h2>
                <p class="mb-0">Enjoy free U.S. shipping</p>
            </div>

            <div class="ss_product_carousel product4_collumn_carousel arrow_ycenter" data-slick='{"dots": false}'>
                <div class="item">
    ...
    <!-- upcoming_section - start
    ================================================== -->
    <section class="upcoming_section sec_ptb_100 clearfix">
        <div class="container maxw_1480">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="ss_upcoming_item">
                        <img src="assets/images/banner/simple_shop/img_05.jpg" alt="image_not_found">
                        <a class="item_name bg_shop_red text-white" href="#!">Clearance</a>
                    </div>
                </div>

                <div class="col-lg-6">
                    <div class="ss_upcoming_item">
                        <img src="assets/images/banner/simple_shop/img_06.jpg" alt="image_not_found">
                        <a class="item_name bg_shop_red text-white" href="#!">Leather Bags</a>
                    </div>

                    <div class="ss_upcoming_item">
                        <img src="assets/images/banner/simple_shop/img_07.jpg" alt="image_not_found">
                        <a class="item_name bg_shop_red text-white" href="#!">jeans Fashion</a>
                    </div>
                </div>
            </div>
    ...
    ================================================== -->
    <section class="instagram_section sec_ptb_100 pb-0 clearfix">
        <div class="container maxw_1480">
            <h2 class="ss_instagram_title text-center mb_50">
                <span class="instagram_icon">
                    <i class="fab fa-instagram"></i>
                </span>
                Instagram
            </h2>
            <ul class="ss_instagram_images ul_li zoom-gallery clearfix">
                <li>
                    <a class="popup_image" href="assets/images/instagram/img_43.jpg">
                        <img src="assets/images/instagram/img_43.jpg" alt="image_not_found">
                    </a>
                </li>
                <li>
                    <a class="popup_image" href="assets/images/instagram/img_44.jpg">
                        <img src="assets/images/instagram/img_44.jpg" alt="image_not_found">
                    </a>
                </li>
                <li>
                    <a class="popup_image" href="assets/images/instagram/img_45.jpg">
                        <img src="assets/images/instagram/img_45.jpg" alt="image_not_found">
                    </a>
                </li>
                <li>
                    <a class="popup_image" href="assets/images/instagram/img_46.jpg">
                        <img src="assets/images/instagram/img_46.jpg" alt="image_not_found">
                    </a>
                </li>
            </ul>
        </div>
