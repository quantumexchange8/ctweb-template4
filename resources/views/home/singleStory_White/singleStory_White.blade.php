...
@section('title')
<title>Single Story White - Current Tech</title>
@endsection

@section('body_class', 'home_single_story')

@section('navbar')
    @include('home.singleStory_White.white_Navbar')
@endsection
...
@section('content')
    <!-- sidebar mobile menu & sidebar cart - start
		...
		<section class="single_story_slider position-relative clearfix">
			<div class="pd_slide d-flex" data-slick='{"dots": false}'>
				<div class="item">
					<div class="slider_content_wrap has_overlay d-flex align-items-center justify-content-center" data-background="assets/images/home_single_story/img_03.jpg">
					...
					<div class="slider_content_wrap">
						<div class="item_image">
							<img src="assets/images/home_single_story/img_03.jpg" alt="image_not_found">
						</div>
					...
					<div class="slider_content_wrap">
						<div class="item_details">
							<div class="details_image">
								<img src="assets/images/home_single_story/img_04.jpg" alt="image_not_found">
							</div>
			...
			<div class="pd_slide_nav d-none" data-slick='{"dots": false, "arrows": false}'>
				<div class="item">
