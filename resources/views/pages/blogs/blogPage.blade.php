...
@section('title')
<title>Blog News - Current Tech</title>
@endsection
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="blog_grid">
                        ...
                        <div class="blog_content">
                            ...
                            <a class="custom_btn bg_default_black text-uppercase" href="/blogs_blogDetails">Read More <i class="fal fa-arrow-circle-right ml-2"></i></a>
                        </div>
                    </div>
                </div>
