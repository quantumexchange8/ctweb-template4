...
@section('title')
<title>Compare page V.1 - Current Tech</title>
@endsection
...
<main>
    ...
    <section class="breadcrumb_section text-white text-center text-uppercase d-flex align-items-end clearfix" data-background="assets/images/breadcrumb/bg_01.jpg">
        ...
        <div class="container">
            <h1 class="page_title text-white">Compare V.1</h1>
    ...
    ================================================== -->
    <div class="compare_section sec_ptb_140 clearfix">
        <div class="container">

            <div class="compare_content_wrap">
                <div class="compare_table">
                    <table class="table mb-0 text-center">
                        <thead>
                            <tr>
                                <th class="text-left">
                                    <span class="title_text">Choose your Package</span>
                                    <p>Every time you attribute</p>
                                </th>
                                <th>
                                    <div class="price_wrap bg_default_red">
                                        <div class="badge bg_default_black">FREE</div>
                                        <strong>$150</strong>
                                        <span>First Month Free</span>
                                    </div>
                                </th>
                                <th>
                                    <div class="price_wrap bg_default_black">
                                        <div class="badge bg_default_red">-30%</div>
                                        <strong>$299</strong>
                                        <span>Discount First month</span>
                                    </div>
                                </th>
                                <th>
                                    <div class="price_wrap bg_default_black">
                                        <div class="badge bg_default_red">-50%</div>
                                        <strong>$399</strong>
                                        <span>Discount First month</span>
                                    </div>
                                </th>
                        ...
                        <tbody>
                            <tr>
                                <td class="text-left"> 
                                    <p>
                                        <span class="tooltips" data-toggle="tooltip" data-placement="top" title="HD and Ultra HD availability subject to your Internet service and device capabilities."><i class="fal fa-info-circle"></i></span>
                                        Monthly price after free month
                                    </p>
                                </td>
                                <td><span class="icon"><i class="fal fa-check"></i></span></td>
                                <td><span class="icon"><i class="fal fa-check"></i></span></td>
                                <td><span class="icon"><i class="fal fa-check"></i></span></td>
                            </tr>
                            <tr>
                                ...
                                <td><span class="icon"><i class="fal fa-times"></i></span></td>
                                <td><span class="icon"><i class="fal fa-check"></i></span></td>
                                <td><span class="icon"><i class="fal fa-check"></i></span></td>
                            </tr>
                            <tr>
                                ...
                                <td><span class="icon">1</span></td>
                                <td><span class="icon">5</span></td>
                                <td><span class="icon">10</span></td>
                            </tr>
                            <tr>
                                <td class="text-left">
                                    <p>
                            ...
                            <tr>
                                <td class="text-left">
                                    <p>
                                        <small>
                                            HD and Ultra HD availability subject to your Internet service and device capabilities. Not all content available in HD or Ultra HD. See <a href="#!">Terms of Use</a> for more details.
                                        </small>
                                    </p>
                                </td>
                                <td><a class="custom_btn bg_default_red" href="#!">ALL PRODUCTS</a></td>
                                <td><a class="custom_btn bg_default_black" href="#!">ALL PRODUCTS</a></td>
                                <td><a class="custom_btn bg_default_black" href="#!">ALL PRODUCTS</a></td>
                            </tr>
                        </tbody>
                    </table>
