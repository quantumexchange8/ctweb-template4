...
@section('title')
<title>Checkout 1st Step - Current Tech</title>
@endsection
    ...
    <section class="cart_section sec_ptb_140 clearfix">
        <div class="container">
            ...
            <ul class="checkout_step ul_li clearfix">
                <li class="active"><a href="/shopInnerPages_checkout_Step1"><span>01.</span> Shopping Cart</a></li>
                <li><a href="/shopInnerPages_checkout_Step2"><span>02.</span> Checkout</a></li>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="cart_pricing_table pt-0 text-uppercase" data-bg-color="#f2f3f5">
                        ...
                        <ul class="ul_li_block clearfix">
                            ...
                            <li><span>Shipping</span> <span><a class="shipping_calculate text-capitalize" href="#!">Calculate shipping</a></span></li>
                            <li><span>Total</span> <span>$197.99</span></li>
                        </ul>
                        <a href="/shopInnerPages_checkout_Step2" class="custom_btn bg_success">Proceed to Checkout</a>
                    </div>
                </div>
            </div>
