...
@section('title')
<title>Checkout 3rd Step Page - Current Tech</title>
@endsection
    ...
    <section class="checkout_section sec_ptb_140 clearfix">
        <div class="container">
            ...
            <ul class="checkout_step ul_li clearfix">
                ...
                <li class="activated"><a href="/shopInnerPages_checkout_Step2"><span>02.</span> Checkout</a></li>
                <li class="active"><a href="/shopInnerPages_checkout_Step3"><span>03.</span> Order Completed</a></li>
            </ul>
