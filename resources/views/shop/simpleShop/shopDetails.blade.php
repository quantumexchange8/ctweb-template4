...
<main>
    ...
    <section class="breadcrumb_section medical_breadcrumb text-center d-flex align-items-center clearfix" data-background="assets/images/breadcrumb/bg_13.jpg">
        <div class="container">
            <h1 class="medical_page_title mb_15">Shop Details</h1>
    ...
    ================================================== -->
    <section class="fm_details_section sec_ptb_100 pb-0 clearfix">
        ...
        <div class="fm_details_description">
            <div class="container">
                <ul class="nav ul_li_center mb_30" role="tablist">
                    ...
                    <li>
                        <a data-toggle="tab" href="#related_products_tab">RELATED PRODUCTS</a>
                    </li>
                </ul>
            </div>
                ...
                <div id="description_tab" class="tab-pane active">
                    ...
                    <div class="row mb_50 no-gutters">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="details_image">
                                <img src="assets/images/details/simple_shop/img_01.jpg" alt="image_not_found">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="details_image">
                                <img src="assets/images/details/simple_shop/img_02.jpg" alt="image_not_found">
                            </div>
                        </div>
                    </div>
                    <div class="container">
